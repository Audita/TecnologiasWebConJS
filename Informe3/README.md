#Sitio Web (Diseño, Calidad, WAI, Validación, SEO)
...
- **¿Qué pasa con Discapacidad?** Para los usuarios con discapacidades como la vision o audicion es necesario de implementar una pagina web con accesibilidad.
